...
export const mailboxes = {
  k_r_o_w: {
    messages: [
      { id: 1, from: 'guest_x', time: '2014/08/08 02:14', content: '看到你在心情板的文了。半夜睡不著的人我懂。', read: true, readAt: '2014/08/08' },
      { id: 2, from: 'k_r_o_w', own: true, time: '2014/08/08 02:19', content: '你也睡不著喔' },
      { id: 3, from: 'guest_x', time: '2014/08/08 02:21', content: '嗯。你聽起來過得不太好。要聊嗎,我不太會睡。', read: true, readAt: '2014/08/08' },
      ...
      { id: 7, from: 'guest_x', time: '2014/08/15 23:45', content: '不會。你想待著就待著。', read: true, readAt: '2014/08/15' },
      ...
      { id: 10, from: 'guest_x', time: '2014/08/25 21:03', content: '週末有個趴,某個大少爺辦的,場面很誇張。', read: true, readAt: '2014/08/25' },
